...
## Environments
- Preview: https://main--aem-boilerplate-forms-new--ujjwal5.hlx.page/
- Live: https://main--aem-boilerplate-forms-new--ujjwal5.hlx.live/
...
1. Open the `aem-boilerplate-forms-new` directory in your favorite IDE and start coding :)
